# LS8AL — HD 106315 exact DEFAULT-L2 screen

22 September 2026. **SCIENCE SCOPE FROZEN BEFORE TABLE ACCESS**.

The rank-13 pair passed its public header-only preflight at
`f7ca069560b1ca38c32c0b2feef8749496b1467d`, following header freeze
`6840dc50cf06e552ef6c24fb4533db7813bd45f5`. All 28 metadata-manifest entries
...
|---|---:|---:|---:|---:|---:|---:|---:|
| CH_PR100041_TG000801_V0300 | 872 | 138 | 20160 | 140495 | 120336 | 1 | 41 / 41 s |
| CH_PR100041_TG001401_V0300 | 1510 | 138 | 20160 | 228539 | 208380 | 1 | 41 / 41 s |

Exactly **328,716 science-table bytes** are authorized.
Source ETags, filenames, total sizes, complete 18-column schema and header
hashes are fixed in config/ls8al_l2_scope.json. PIPE_VER=14.1.2 in both.
The original/reconciled rank-13 chronology is unchanged. No other aperture,
visit, extension, padding, image or raw imagette is included. These are the two eligible HD 106315 visits in the original cohort.
...
- Durations: one/two/three rows, **41/82/123 seconds** per visit.
...
If neither sign crosses, close this HD 106315 pair as a descriptive null. The
next predetermined cohort is rank-14 **WASP-103**, chronological pair
CH_PR100013_TG000101_V0300 and CH_PR100013_TG000102_V0300, requiring separate
header/table freezes. Do not tune or expand the closed HD 106315 pair.
