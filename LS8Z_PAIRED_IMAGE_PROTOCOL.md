# LS8Z — exact PG 1245-042 image payload and unchanged diagnostic

21 September 2026. **FROZEN BEFORE IMAGE OR SMEARING VALUES**.
Metadata freeze: `a4256a35cfc7c983297c6d8802932d8fa7b7a6af`.
Metadata result: `f74c8d4834e2b4e40a6cdedc039d29dfc067945c`.
Audited L2 source: `588398eacf6316324d24954150b57e69422f2d0a`.
...
**TG008601_N0**, negative, L2 row 31, one 60-second exposure,
original score -18.490171716816285. The second selected visit and both
positive cluster sets are empty. The score is not Gaussian sigma.

## Exact source identities and byte intervals

Use only CH_PR100002_TG008601_V0300 CAL/COR products. Exact filenames, ETags,
total sizes and metadata identities are retained in config/ls8z_images.json.
Both image arrays are unscaled big-endian float64, 200x200 native
ADU, 320,000 bytes per frame. Both products have 85
...
|---|---:|---:|---:|
| SCI_CAL_SubArray | 5457280 | 9280000 | 14737279 |
| SCI_COR_SubArray | 5457280 | 9280000 | 14737279 |
| SMEAR | 27306560 | 46400 | 27352959 |

The original L2 context is 17:46. Native image indices and contiguous
...
in config/ls8z_payload_scope.json. Verify all pins, freeze HEAD and clean
...
are AST-identical to LS8X/LS8T. Independently decode retained bytes, check raw
...
close PG 1245-042 and prepare rank-8 WASP-43 with separate header/table freezes.
