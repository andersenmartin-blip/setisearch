"""M43R fixed-calibration diagnostic detector; frozen M43Q downstream arithmetic.
...
def calibrate(*,window,grid,bank,table,basis,scans,store,shifts,minimum_shift_bins,progress=lambda m:None):
...
def execute(*,window,grid,bank,table,basis,scans,store,calibration,threshold,receiver_factory,maximum_records=10000,progress=lambda message:None):
    ...
    result={'schema':'m43r-fixed-threshold-diagnostic-v1','purpose':'bounded-native-injection-pilot',
