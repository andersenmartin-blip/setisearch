"""M43T paired mask comparison; downstream M43R arithmetic copied unchanged.
...
from .mask_m43t import build_mask, validate_binding
...
def execute(*,mask_policy,calibration_binding,window,grid,bank,table,basis,scans,store,calibration,threshold,receiver_factory,maximum_records=10000,progress=lambda message:None):
    ...
    result={'schema':'m43t-mask-comparison-diagnostic-v1','purpose':'paired-mask-sensitivity-comparison',
