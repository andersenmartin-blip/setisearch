# LS8AF — PG 1207-033 exact DEFAULT-L2 screen

22 September 2026. **SCIENCE SCOPE FROZEN BEFORE TABLE ACCESS**.

The rank-10 pair passed its public header-only preflight at
`4301fd51c7b0d5a8ad94c428534140726b23b66b`, following header freeze
`ee96b52952d038d403cada81bc3c2f1c97f38782`. All 28 metadata-manifest entries
...
|---|---:|---:|---:|---:|---:|---:|---:|
| CH_PR100002_TG000901_V0300 | 81 | 138 | 20160 | 31337 | 11178 | 1 | 60 / 60 s |
| CH_PR100002_TG000902_V0300 | 72 | 138 | 20160 | 30095 | 9936 | 1 | 60 / 60 s |

Exactly **21,114 science-table bytes** are authorized.
Source ETags, filenames, total sizes, complete 18-column schema and header
hashes are fixed in config/ls8af_l2_scope.json. PIPE_VER=14.1.2 in both.
The original/reconciled rank-10 chronology is unchanged. No other aperture,
visit, extension, padding, image or raw imagette is included. These are the only two
eligible visits in this cohort; no other visit is included.
...
If neither sign crosses, close this PG 1207-033 pair as a descriptive null. The
next predetermined cohort is rank-11 **EC13080-1508**, chronological pair
CH_PR100002_TG005201_V0300 and CH_PR100002_TG005202_V0300, requiring separate
header/table freezes. Do not tune or expand the closed PG 1207-033 pair.
