# LS8AV — GJ 9404 two-visit DEFAULT-L2 screen

Completed 23 September 2026. Result: **COMPLETE_AUDITED**.

The unchanged symmetric screen evaluated **145 table rows** and
**150 eligible, overlapping windows**. It retained
...
|---|---:|---:|---:|---:|
| CH_PR100018_TG007301_V0300 | 59 | 90 | 0 / 0 | 0 / 0 |
| CH_PR100018_TG007302_V0300 | 86 | 60 | 0 / 0 | 0 / 0 |
...
`7d72620d9e17aa4617214c8cf0d589c37374dfb0`. Both products have NEXP=1. Their verified
...
Exactly **20,010 science-table bytes** were acquired.
...
**1,800 numerical and discrete comparisons**
...
Close this two-visit GJ 9404 screen as a descriptive null. The next independent cohort is rank 19 of the unchanged reconciled LS8J ledger, EC14338-1445. Freeze its exact pair and header preflight before accessing that cohort. Do not widen or retune the closed GJ 9404 pair.
