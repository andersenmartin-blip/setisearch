# LS8AW — EC14338-1445 two-visit DEFAULT-L2 screen

Completed 23 September 2026. Result: **COMPLETE_AUDITED**.

The unchanged symmetric screen evaluated **159 table rows** and
**63 eligible, overlapping windows**. It retained
...
|---|---:|---:|---:|---:|
| CH_PR100002_TG006601_V0300 | 79 | 60 | 0 / 0 | 0 / 0 |
| CH_PR100002_TG006602_V0300 | 80 | 3 | 0 / 0 | 0 / 0 |
...
`2eea576bba91ed38b9141006bf8c56ee6a823fa6`. Both products have NEXP=1. Their verified
...
Exactly **21,942 science-table bytes** were acquired.
...
**756 numerical and discrete comparisons**
...
Close this two-visit EC14338-1445 screen as a descriptive null. The next independent cohort is rank 20 of the unchanged reconciled LS8J ledger, GJ 536. Freeze its exact pair and header preflight before accessing that cohort. Do not widen or retune the closed EC14338-1445 pair.
