# LS8AA — WASP-43 exact DEFAULT-L2 screen

21 September 2026. **SCIENCE SCOPE FROZEN BEFORE TABLE ACCESS**.

The rank-8 pair passed its public header-only preflight at
`1ab2ec20735219cf51d072f0f7fafb7db3da83ee`, following header freeze
`22364505ef80340ac3ce39a95a2286281492264c`. All 28 metadata-manifest entries
...
|---|---:|---:|---:|---:|---:|---:|---:|
| CH_PR100016_TG007801_V0300 | 137 | 138 | 20160 | 39065 | 18906 | 1 | 60 / 60 s |
| CH_PR100016_TG007802_V0300 | 134 | 138 | 20160 | 38651 | 18492 | 1 | 60 / 60 s |

Exactly **37,398 science-table bytes** are authorized.
Source ETags, filenames, total sizes, complete 18-column schema and header
hashes are fixed in config/ls8aa_l2_scope.json. PIPE_VER=14.1.2 in both.
The original/reconciled rank-8 chronology is unchanged. No other aperture,
visit, extension, padding, image or raw imagette is included.
...
If neither sign crosses, close this WASP-43 pair as a descriptive null. The
next predetermined cohort is rank-9 **PG1303-114**, chronological pair
CH_PR100002_TG006401_V0300 and CH_PR100002_TG006402_V0300, requiring separate
header/table freezes. Do not tune or expand the closed WASP-43 pair.
