#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8AX GJ536 visits."""
...
OUT=ROOT/'results_ls8ax_l2_metadata'
...
def main():
 ...
 assert recon['eligible_cohorts'][19]==cfg['cohort']
 assert cfg['cohort']['rank']==20 and cfg['cohort']['normalized_target']=='gj536'
 ...
 s={'stage':'LS8AX_GJ536_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
