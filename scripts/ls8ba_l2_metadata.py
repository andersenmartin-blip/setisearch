#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8BA 2MASSJ11285624 visits."""
...
OUT=ROOT/'results_ls8ba_l2_metadata'
...
def main():
 ...
 assert recon['eligible_cohorts'][20]==cfg['cohort']
 assert cfg['cohort']['rank']==21 and cfg['cohort']['normalized_target']=='2massj112856241010395'
 ...
 s={'stage':'LS8BA_2MASSJ11285624_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
