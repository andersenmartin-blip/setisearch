#!/usr/bin/env python3
"""Fetch the official rho CrB c orbit and host astrometry only."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results_m20_selected_metadata/rhocrbc.json"),
    )
    ...
    request = Request(url, headers={"User-Agent": "setisearch-m20-metadata/1.0"})
    ...
    result = {
        "purpose": "Milestone 20 selected-target official metadata completion",
