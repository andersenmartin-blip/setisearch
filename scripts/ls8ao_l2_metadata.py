#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8AO WASP103 visits."""
...
OUT=ROOT/'results_ls8ao_l2_metadata'
BASE='https://cheops-webapp-pg.obsuksprd2.unige.ch/'
KEYS=['CH_PR100013_TG000101_V0300','CH_PR100013_TG000102_V0300']
...
def one(key):
 ...
 exp={
  'CH_PR100013_TG000101_V0300':(1,60.,60.),
  'CH_PR100013_TG000102_V0300':(1,60.,60.),
 }[key]
...
def main():
 ...
 cfg=json.loads((ROOT/'config/ls8ao_selected_pair.json').read_text())
 ...
 assert recon['eligible_cohorts'][13]==cfg['cohort']
 assert cfg['cohort']['rank']==14 and cfg['cohort']['normalized_target']=='wasp103'
 ...
 s={'stage':'LS8AO_WASP103_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
