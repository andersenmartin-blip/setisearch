...
def run(config_path,out,data_dir):
    ...
    if config['artifact_type']!='seti_repeater.ls6_preregistration' or config['freeze_boundary']['medium_resolution_values_read_before_freeze']:raise RuntimeError('invalid freeze')
