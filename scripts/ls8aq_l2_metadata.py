#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8AQ GJ581 visits."""
...
OUT=ROOT/'results_ls8aq_l2_metadata'
BASE='https://cheops-webapp-pg.obsuksprd2.unige.ch/'
KEYS=['CH_PR100011_TG023701_V0300','CH_PR100018_TG008301_V0300']
...
def one(key):
 ...
 exp={
  'CH_PR100011_TG023701_V0300':(1,60.,60.),
  'CH_PR100018_TG008301_V0300':(1,60.,60.),
 }[key]
...
def main():
 ...
 cfg=json.loads((ROOT/'config/ls8aq_selected_pair.json').read_text())
 ...
 assert recon['eligible_cohorts'][14]==cfg['cohort']
 assert cfg['cohort']['rank']==15 and cfg['cohort']['normalized_target']=='gj581'
 ...
 s={'stage':'LS8AQ_GJ581_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
