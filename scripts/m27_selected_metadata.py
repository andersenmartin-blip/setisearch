#!/usr/bin/env python3
"""Fetch the official HD 127506 b orbit and host astrometry only."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results_m27_selected_metadata/hd127506b.json"),
    )
    ...
    request = Request(url, headers={"User-Agent": "setisearch-m27-metadata/1.0"})
    ...
    result = {
        "purpose": "Milestone 27 selected-target official metadata completion",
