#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8W GJ436 visits."""
...
OUT=ROOT/'results_ls8w_l2_metadata'
...
def one(key):
 ...
 exp={
  'CH_PR100041_TG000302_V0300':(1,60.,60.),
  'CH_PR100041_TG001301_V0300':(1,60.,60.),
 }[key]
...
def main():
 ...
 cfg=json.loads((ROOT/'config/ls8w_selected_pair.json').read_text())
 ...
 assert recon['eligible_cohorts'][5]==cfg['cohort']
 assert cfg['cohort']['rank']==6 and cfg['cohort']['normalized_target']=='gj436'
 ...
 s={'stage':'LS8W_GJ436_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
