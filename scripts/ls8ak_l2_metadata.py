#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8AK PG1343102 visits."""
...
OUT=ROOT/'results_ls8ak_l2_metadata'
BASE='https://cheops-webapp-pg.obsuksprd2.unige.ch/'
KEYS=['CH_PR100002_TG008701_V0300','CH_PR100002_TG008702_V0300']
...
def one(key):
 ...
 exp={
  'CH_PR100002_TG008701_V0300':(1,60.,60.),
  'CH_PR100002_TG008702_V0300':(1,60.,60.),
 }[key]
...
def main():
 ...
 cfg=json.loads((ROOT/'config/ls8ak_selected_pair.json').read_text())
 ...
 assert recon['eligible_cohorts'][11]==cfg['cohort']
 assert cfg['cohort']['rank']==12 and cfg['cohort']['normalized_target']=='pg1343102'
 ...
 s={'stage':'LS8AK_PG1343102_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
