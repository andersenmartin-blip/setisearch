#!/usr/bin/env python3
"""Re-run the unchanged LS1 broadband injection as the LS4B detector-core gate."""
...
def run_validation() -> dict:
    ...
    result["artifact_type"] = "seti_repeater.ls4b_synthetic_validation"
    result["inherited_detector_core"] = "LS1 unchanged"
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=Path("results_ls4b/synthetic_validation.json"))
