#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8AC PG1303114 visits."""
...
OUT=ROOT/'results_ls8ac_l2_metadata'
BASE='https://cheops-webapp-pg.obsuksprd2.unige.ch/'
KEYS=['CH_PR100002_TG006401_V0300','CH_PR100002_TG006402_V0300']
...
def one(key):
 ...
 exp={
  'CH_PR100002_TG006401_V0300':(1,60.,60.),
  'CH_PR100002_TG006402_V0300':(1,60.,60.),
 }[key]
...
def main():
 ...
 cfg=json.loads((ROOT/'config/ls8ac_selected_pair.json').read_text())
 ...
 assert recon['eligible_cohorts'][8]==cfg['cohort']
 assert cfg['cohort']['rank']==9 and cfg['cohort']['normalized_target']=='pg1303114'
 ...
 s={'stage':'LS8AC_PG1303114_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
