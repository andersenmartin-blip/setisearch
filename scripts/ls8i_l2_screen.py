#!/usr/bin/env python3
"""Evaluate the frozen two-visit LS8I GJ 649 DEFAULT-L2 screen."""
...
def main() -> None:
    ...
    assert not OUT.exists(), "refuse completed LS8I screen overwrite"
    ...
    summary = {
        "stage": "LS8I_GJ649_TWO_VISIT_L2_SCREEN",
