#!/usr/bin/env python3
"""Report every fixed LS8T image outcome without altering the diagnostics."""
import json
import math
...
def main():
    ...
    if unresolved:
        ...
        next_action=('Close both TESS_260647166 follow-up branches under their fixed descriptive labels without widening. '
                     'The next independent target is rank 5 of the unchanged reconciled LS8J ledger, EC 12578-2107; '
                     'freeze its exact pair and header preflight before science values.')
    count=audit['comparisons']
    text=f'''# LS8T — both TESS_260647166 paired-image follow-ups
