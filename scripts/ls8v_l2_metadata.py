#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8V EC125782107 visits."""
...
OUT=ROOT/'results_ls8v_l2_metadata'
BASE='https://cheops-webapp-pg.obsuksprd2.unige.ch/'
KEYS=['CH_PR100002_TG008901_V0300','CH_PR100002_TG008902_V0300']
...
def one(key):
 ...
 exp={
  'CH_PR100002_TG008901_V0300':(1,60.,60.),
  'CH_PR100002_TG008902_V0300':(1,60.,60.),
 }[key]
...
def main():
 ...
 cfg=json.loads((ROOT/'config/ls8v_selected_pair.json').read_text())
 ...
 assert recon['eligible_cohorts'][4]==cfg['cohort']
 assert cfg['cohort']['rank']==5 and cfg['cohort']['normalized_target']=='ec125782107'
 ...
 s={'stage':'LS8V_EC125782107_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
