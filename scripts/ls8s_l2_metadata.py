#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8S TESS_260647166 visits."""
...
OUT=ROOT/'results_ls8s_l2_metadata'
...
def one(key):
 ...
 exp={
  'CH_PR300046_TG000101_V0300':(1,42.,42.),
  'CH_PR100031_TG015701_V0300':(1,49.,49.),
 }[key]
...
def main():
 ...
 cfg=json.loads((ROOT/'config/ls8s_selected_pair.json').read_text())
 ...
 assert recon['eligible_cohorts'][3]==cfg['cohort']
 assert cfg['cohort']['rank']==4 and cfg['cohort']['normalized_target']=='tess260647166'
 ...
 s={'stage':'LS8S_TESS260647166_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
