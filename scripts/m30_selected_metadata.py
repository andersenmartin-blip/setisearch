#!/usr/bin/env python3
"""Fetch the official bet UMi b orbit and host astrometry only."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results_m30_selected_metadata/betumib.json"),
    )
    ...
    request = Request(url, headers={"User-Agent": "setisearch-m30-metadata/1.0"})
    ...
    result = {
        "purpose": "Milestone 30 selected-target official metadata completion",
