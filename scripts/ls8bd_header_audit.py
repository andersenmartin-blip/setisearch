#!/usr/bin/env python3
"""Independent scalar FITS-card audit of retained LS8BD headers; no network."""
import hashlib
import json
import struct
...
META = ROOT / 'results_ls8bd_l2_metadata'
OUT = ROOT / 'verification_ls8bd'
...
def main():
    ...
    for visit, p in zip(cfg['cohort']['selected_visits'], suite['products'], strict=True):
        ...
        expected_hex = {'CH_PR100018_TG007401_V0300': '42280000',
                        'CH_PR100018_TG007402_V0300': '42280000'}[key]
