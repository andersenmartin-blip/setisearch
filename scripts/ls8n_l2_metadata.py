#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8N GJ 1132 visits."""
import hashlib, json
...
OUT=ROOT/'results_ls8n_l2_metadata'
...
def one(key):
 ...
 exp={
  'CH_PR100041_TG000401_V0300':(1,60.0,60.0),
  'CH_PR100041_TG000403_V0300':(1,60.0,60.0),
 }[key]
...
def main():
 ...
 cfg=json.loads((ROOT/'config/ls8n_selected_pair.json').read_text())
 ...
 assert recon['eligible_cohorts'][1]==cfg['cohort']
 assert cfg['cohort']['rank']==2 and cfg['cohort']['normalized_target']=='gj1132'
 ...
 s={'stage':'LS8N_GJ1132_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
