#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8F GJ 514 visits."""
import hashlib, json
...
OUT=ROOT/'results_ls8f_l2_metadata'
BASE='https://cheops-webapp-pg.obsuksprd2.unige.ch/'
KEYS=['CH_PR100018_TG007501_V0300','CH_PR100018_TG007502_V0300']
EXPECTED={
 'CH_PR100018_TG007501_V0300':'CH_PR100018_TG007501_TU2020-05-16T03-42-00_SCI_COR_Lightcurve-DEFAULT_V0300.fits',
 'CH_PR100018_TG007502_V0300':'CH_PR100018_TG007502_TU2020-05-19T21-49-20_SCI_COR_Lightcurve-DEFAULT_V0300.fits',
}
...
def one(key):
 ...
 assert str(kw['PIPE_VER'])=='14.1.2' and int(kw['NEXP'])==2
 assert abs(float(kw['EXPTIME'])-22.0)<1e-9 and abs(float(kw['TEXPTIME'])-44.0)<1e-6
...
def main():
 ...
 s={'stage':'LS8F_GJ514_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
