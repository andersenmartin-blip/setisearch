#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8Y PG1245042 visits."""
...
OUT=ROOT/'results_ls8y_l2_metadata'
BASE='https://cheops-webapp-pg.obsuksprd2.unige.ch/'
KEYS=['CH_PR100002_TG008601_V0300','CH_PR100002_TG008602_V0300']
...
def one(key):
 ...
 exp={
  'CH_PR100002_TG008601_V0300':(1,60.,60.),
  'CH_PR100002_TG008602_V0300':(1,60.,60.),
 }[key]
...
def main():
 ...
 cfg=json.loads((ROOT/'config/ls8y_selected_pair.json').read_text())
 ...
 assert recon['eligible_cohorts'][6]==cfg['cohort']
 assert cfg['cohort']['rank']==7 and cfg['cohort']['normalized_target']=='pg1245042'
 ...
 s={'stage':'LS8Y_PG1245042_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
