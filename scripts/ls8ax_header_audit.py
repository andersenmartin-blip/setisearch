#!/usr/bin/env python3
"""Independent scalar FITS-card audit of retained LS8AX headers; no network."""
import hashlib
import json
import struct
...
META = ROOT / 'results_ls8ax_l2_metadata'
OUT = ROOT / 'verification_ls8ax'
...
def main():
    cfg = json.loads((ROOT / 'config/ls8ax_selected_pair.json').read_text())
    ...
    for visit, p in zip(cfg['cohort']['selected_visits'], suite['products'], strict=True):
        ...
        expected_hex = {'CH_PR100011_TG023501_V0300': '4220ae14',
                        'CH_PR100018_TG007801_V0300': '4220cccd'}[key]
