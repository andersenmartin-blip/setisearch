#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8I GJ 649 visits."""
import hashlib, json
...
OUT=ROOT/'results_ls8i_l2_metadata'
BASE='https://cheops-webapp-pg.obsuksprd2.unige.ch/'
KEYS=['CH_PR100018_TG018601_V0300','CH_PR100018_TG031201_V0300']
...
def one(key):
 ...
 exp={
  'CH_PR100018_TG018601_V0300':(1,22.6499996185303,22.6499996185303),
  'CH_PR100018_TG031201_V0300':(14,3.0,42.0),
 }[key]
...
def main():
 ...
 s={'stage':'LS8I_GJ649_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
