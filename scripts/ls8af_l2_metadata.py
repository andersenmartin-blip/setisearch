#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8AF PG1207033 visits."""
...
OUT=ROOT/'results_ls8af_l2_metadata'
BASE='https://cheops-webapp-pg.obsuksprd2.unige.ch/'
KEYS=['CH_PR100002_TG000901_V0300','CH_PR100002_TG000902_V0300']
...
def one(key):
 ...
 exp={
  'CH_PR100002_TG000901_V0300':(1,60.,60.),
  'CH_PR100002_TG000902_V0300':(1,60.,60.),
 }[key]
...
def main():
 ...
 cfg=json.loads((ROOT/'config/ls8af_selected_pair.json').read_text())
 ...
 assert recon['eligible_cohorts'][9]==cfg['cohort']
 assert cfg['cohort']['rank']==10 and cfg['cohort']['normalized_target']=='pg1207033'
 ...
 s={'stage':'LS8AF_PG1207033_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
