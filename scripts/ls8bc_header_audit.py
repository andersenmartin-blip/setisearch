#!/usr/bin/env python3
"""Independent scalar FITS-card audit of retained LS8BC headers; no network."""
import hashlib
import json
import struct
...
META = ROOT / 'results_ls8bc_l2_metadata'
...
def main():
    cfg = json.loads((ROOT / 'config/ls8bc_selected_pair.json').read_text())
    ...
    for visit, p in zip(cfg['cohort']['selected_visits'], suite['products'], strict=True):
        ...
        expected_hex = {'CH_PR100018_TG012201_V0300': '42700000',
                        'CH_PR100018_TG012202_V0300': '42700000'}[key]
