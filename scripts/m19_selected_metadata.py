#!/usr/bin/env python3
"""Fetch the official 47 UMa d orbit and host astrometry only."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results_m19_selected_metadata/47umad.json"),
    )
    ...
    request = Request(url, headers={"User-Agent": "setisearch-m19-metadata/1.0"})
    ...
    result = {
        "purpose": "Milestone 19 selected-target official metadata completion",
