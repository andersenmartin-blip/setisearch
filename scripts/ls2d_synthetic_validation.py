#!/usr/bin/env python3
"""Re-run the unchanged LS1 broadband injection as the LS2D detector gate."""
...
def run_validation() -> dict:
    ...
    result["artifact_type"] = "seti_repeater.ls2d_synthetic_validation"
...
def main() -> None:
    ...
    parser.add_argument(
        "--output", type=Path, default=Path("results_ls2d/synthetic_validation.json")
    )
