#!/usr/bin/env python3
"""Fetch the official HIP 48714 b orbit and host astrometry only."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results_m36_selected_metadata/hip48714b.json"),
    )
    ...
    request = Request(url, headers={"User-Agent": "setisearch-m36-metadata/1.0"})
    ...
    result = {
        "purpose": "Milestone 36 selected-target official metadata completion",
