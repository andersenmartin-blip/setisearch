#!/usr/bin/env python3
"""Fetch the official 16 Cyg B b orbit and host astrometry only."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results_m24_selected_metadata/16cygbb.json"),
    )
    ...
    request = Request(url, headers={"User-Agent": "setisearch-m24-metadata/1.0"})
    ...
    result = {
        "purpose": "Milestone 24 selected-target official metadata completion",
