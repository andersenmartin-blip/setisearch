#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8AI EC130801508 visits."""
...
OUT=ROOT/'results_ls8ai_l2_metadata'
BASE='https://cheops-webapp-pg.obsuksprd2.unige.ch/'
KEYS=['CH_PR100002_TG005201_V0300','CH_PR100002_TG005202_V0300']
...
def one(key):
 ...
 exp={
  'CH_PR100002_TG005201_V0300':(1,60.,60.),
  'CH_PR100002_TG005202_V0300':(1,60.,60.),
 }[key]
...
def main():
 ...
 cfg=json.loads((ROOT/'config/ls8ai_selected_pair.json').read_text())
 ...
 assert recon['eligible_cohorts'][10]==cfg['cohort']
 assert cfg['cohort']['rank']==11 and cfg['cohort']['normalized_target']=='ec130801508'
 ...
 s={'stage':'LS8AI_EC130801508_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
