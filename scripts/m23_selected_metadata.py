#!/usr/bin/env python3
"""Fetch the official HD 33564 b orbit and host astrometry only."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results_m23_selected_metadata/hd33564b.json"),
    )
    ...
    request = Request(url, headers={"User-Agent": "setisearch-m23-metadata/1.0"})
    ...
    result = {
        "purpose": "Milestone 23 selected-target official metadata completion",
