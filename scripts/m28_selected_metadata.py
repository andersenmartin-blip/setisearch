#!/usr/bin/env python3
"""Fetch the official psi1 Dra B b orbit and host astrometry only."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results_m28_selected_metadata/psi1drabb.json"),
    )
    ...
    request = Request(url, headers={"User-Agent": "setisearch-m28-metadata/1.0"})
    ...
    result = {
        "purpose": "Milestone 28 selected-target official metadata completion",
