#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8AW EC143381445 visits."""
...
OUT=ROOT/'results_ls8aw_l2_metadata'
BASE='https://cheops-webapp-pg.obsuksprd2.unige.ch/'
KEYS=['CH_PR100002_TG006601_V0300','CH_PR100002_TG006602_V0300']
...
def one(key):
 ...
 exp={
  'CH_PR100002_TG006601_V0300':(1,60.,60.),
  'CH_PR100002_TG006602_V0300':(1,60.,60.),
 }[key]
...
def main():
 ...
 cfg=json.loads((ROOT/'config/ls8aw_selected_pair.json').read_text())
 ...
 assert recon['eligible_cohorts'][18]==cfg['cohort']
 assert cfg['cohort']['rank']==19 and cfg['cohort']['normalized_target']=='ec143381445'
 ...
 s={'stage':'LS8AW_EC143381445_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
