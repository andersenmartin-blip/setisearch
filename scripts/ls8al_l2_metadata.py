#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8AL HD106315 visits."""
...
OUT=ROOT/'results_ls8al_l2_metadata'
...
def one(key):
 ...
 exp={
  'CH_PR100041_TG000801_V0300':(1,41.,41.),
  'CH_PR100041_TG001401_V0300':(1,41.,41.),
 }[key]
...
def main():
 ...
 cfg=json.loads((ROOT/'config/ls8al_selected_pair.json').read_text())
 ...
 assert recon['eligible_cohorts'][12]==cfg['cohort']
 assert cfg['cohort']['rank']==13 and cfg['cohort']['normalized_target']=='hd106315'
 ...
 s={'stage':'LS8AL_HD106315_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
