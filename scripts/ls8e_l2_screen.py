#!/usr/bin/env python3
"""Evaluate the frozen two-visit LS8E GJ 876 DEFAULT-L2 screen."""
...
META = ROOT / "results_ls8e_l2_metadata"
OUT = ROOT / "results_ls8e_l2_screen"
...
def main() -> None:
    ...
    assert not OUT.exists(), "refuse completed LS8E screen overwrite"
    ...
    summary = {
        "stage": "LS8E_GJ876_TWO_VISIT_L2_SCREEN",
