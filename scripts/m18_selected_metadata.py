#!/usr/bin/env python3
"""Fetch the official GJ 649 b orbit and host astrometry only."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results_m18_selected_metadata/gj649b.json"),
    )
    ...
    request = Request(url, headers={"User-Agent": "setisearch-m18-metadata/1.0"})
    ...
    result = {
        "purpose": "Milestone 18 selected-target official metadata completion",
