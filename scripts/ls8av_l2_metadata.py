#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8AV GJ9404 visits."""
...
OUT=ROOT/'results_ls8av_l2_metadata'
BASE='https://cheops-webapp-pg.obsuksprd2.unige.ch/'
KEYS=['CH_PR100018_TG007301_V0300','CH_PR100018_TG007302_V0300']
...
def one(key):
 ...
 exp={
  'CH_PR100018_TG007301_V0300':(1,60.,60.),
  'CH_PR100018_TG007302_V0300':(1,60.,60.),
 }[key]
...
def main():
 ...
 assert recon['eligible_cohorts'][17]==cfg['cohort']
 assert cfg['cohort']['rank']==18 and cfg['cohort']['normalized_target']=='gj9404'
 ...
 s={'stage':'LS8AV_GJ9404_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
