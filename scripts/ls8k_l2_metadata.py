#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8K WASP-189 visits."""
import hashlib, json
...
OUT=ROOT/'results_ls8k_l2_metadata'
...
def one(key):
 ...
 reference=json.loads((ROOT/'results_ls8i_l2_metadata/summary.json').read_text())['products'][0]['columns']
 ...
 exp={
  'CH_PR100041_TG000201_V0300':(7,4.80000019073486,33.6000022888184),
  'CH_PR100041_TG000202_V0300':(7,4.80000019073486,33.6000022888184),
 }[key]
...
def main():
 ...
 assert [v['file_key'] for v in recon['selection']['selected_visits']]==KEYS
 ...
 s={'stage':'LS8K_WASP189_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
