#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8AU LSIV092 visits."""
...
OUT=ROOT/'results_ls8au_l2_metadata'
BASE='https://cheops-webapp-pg.obsuksprd2.unige.ch/'
KEYS=['CH_PR100002_TG009301_V0300','CH_PR100002_TG009302_V0300']
...
def one(key):
 ...
 exp={
  'CH_PR100002_TG009301_V0300':(1,60.,60.),
  'CH_PR100002_TG009302_V0300':(1,60.,60.),
 }[key]
...
def main():
 ...
 cfg=json.loads((ROOT/'config/ls8au_selected_pair.json').read_text())
 ...
 assert recon['eligible_cohorts'][16]==cfg['cohort']
 assert cfg['cohort']['rank']==17 and cfg['cohort']['normalized_target']=='lsiv092'
 ...
 s={'stage':'LS8AU_LSIV092_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
