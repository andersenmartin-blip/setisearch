#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8Q HD 136352 visits."""
...
OUT=ROOT/'results_ls8q_l2_metadata'
...
def one(key):
 ...
 exp={
  'CH_PR100041_TG000901_V0300':(26,1.70000004768372,44.2000007629395),
  'CH_PR100041_TG000101_V0300':(26,1.70000004768372,44.2000007629395),
 }[key]
...
def main():
 ...
 cfg=json.loads((ROOT/'config/ls8q_selected_pair.json').read_text())
 ...
 assert recon['eligible_cohorts'][2]==cfg['cohort']
 assert cfg['cohort']['rank']==3 and cfg['cohort']['normalized_target']=='hd136352'
 ...
 s={'stage':'LS8Q_HD136352_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
