#!/usr/bin/env python3
"""Transfer pinned LS8K acquisition/scoring functions to the frozen 2MASS J11285624+1010395 pair."""
import argparse
import hashlib
import json
...
KEYS = ['CH_PR100018_TG010801_V0300', 'CH_PR100018_TG010802_V0300']
...
def main():
    ...
    assert not OUT.exists(), 'refuse LS8BA output overwrite'
    cfg = json.loads((ROOT / 'config/ls8ba_l2_scope.json').read_text())
    ...
    summary = {'stage': 'LS8BA_2MASSJ11285624_TWO_VISIT_L2_SCREEN', 'status': 'COMPLETE_UNAUDITED',
        'evaluation_freeze_commit': args.freeze, 'target': '2MASS J11285624+1010395', 'selected_keys': KEYS,
        ...
        'interpretation': 'Independent rank-21 two-visit L2 screen; signed endpoints are not Gaussian significances.'}
