#!/usr/bin/env python3
"""Fetch the official HD 87883 b orbit and host astrometry only."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results_m22_selected_metadata/hd87883b.json"),
    )
    ...
    request = Request(url, headers={"User-Agent": "setisearch-m22-metadata/1.0"})
    ...
    result = {
        "purpose": "Milestone 22 selected-target official metadata completion",
