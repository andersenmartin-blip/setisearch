#!/usr/bin/env python3
"""Fetch the official HD 192263 b orbit and host astrometry only."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results_m31_selected_metadata/hd192263b.json"),
    )
    ...
    request = Request(url, headers={"User-Agent": "setisearch-m31-metadata/1.0"})
    ...
    result = {
        "purpose": "Milestone 31 selected-target official metadata completion",
