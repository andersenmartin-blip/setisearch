#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8BC GJ422 visits."""
...
OUT=ROOT/'results_ls8bc_l2_metadata'
...
def main():
 ...
 assert recon['eligible_cohorts'][21]==cfg['cohort']
 assert cfg['cohort']['rank']==22 and cfg['cohort']['normalized_target']=='gj422'
 ...
 s={'stage':'LS8BC_GJ422_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
