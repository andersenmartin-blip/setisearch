#!/usr/bin/env python3
"""Fetch the official HD 164922 b orbit and host astrometry only."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results_m25_selected_metadata/hd164922b.json"),
    )
    ...
    request = Request(url, headers={"User-Agent": "setisearch-m25-metadata/1.0"})
    ...
    result = {
        "purpose": "Milestone 25 selected-target official metadata completion",
