#!/usr/bin/env python3
"""Fetch the official HD 3651 b orbit and host astrometry only."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results_m33_selected_metadata/hd3651b.json"),
    )
    ...
    request = Request(url, headers={"User-Agent": "setisearch-m33-metadata/1.0"})
    ...
    result = {
        "purpose": "Milestone 33 selected-target official metadata completion",
