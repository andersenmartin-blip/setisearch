#!/usr/bin/env python3
"""Evaluate the frozen two-visit LS8G GJ 849 DEFAULT-L2 screen."""
...
META = ROOT / "results_ls8g_l2_metadata"
OUT = ROOT / "results_ls8g_l2_screen"
...
def main() -> None:
    ...
    assert not OUT.exists(), "refuse completed LS8G screen overwrite"
    ...
    summary = {
        "stage": "LS8G_GJ849_TWO_VISIT_L2_SCREEN",
