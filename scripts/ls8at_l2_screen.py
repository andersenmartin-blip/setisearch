#!/usr/bin/env python3
"""Transfer pinned LS8K acquisition/scoring functions to the frozen EC 14599-2047 pair."""
import argparse
import hashlib
import json
...
META = ROOT / 'results_ls8at_l2_metadata'
...
def main():
    ...
    assert not OUT.exists(), 'refuse LS8AT output overwrite'
    cfg = json.loads((ROOT / 'config/ls8at_l2_scope.json').read_text())
    ...
    summary = {'stage': 'LS8AT_EC145992047_TWO_VISIT_L2_SCREEN', 'status': 'COMPLETE_UNAUDITED',
        'evaluation_freeze_commit': args.freeze, 'target': 'EC 14599-2047', 'selected_keys': KEYS,
        ...
        'interpretation': 'Independent rank-16 two-visit L2 screen; signed endpoints are not Gaussian significances.'}
