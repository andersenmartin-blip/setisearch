#!/usr/bin/env python3
"""Fetch the official HD 11964 b orbit and host astrometry only."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results_m29_selected_metadata/hd11964b.json"),
    )
    ...
    request = Request(url, headers={"User-Agent": "setisearch-m29-metadata/1.0"})
    ...
    result = {
        "purpose": "Milestone 29 selected-target official metadata completion",
