#!/usr/bin/env python3
"""Fetch the official HD 99492 b orbit and host astrometry only."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results_m32_selected_metadata/hd99492b.json"),
    )
    ...
    request = Request(url, headers={"User-Agent": "setisearch-m32-metadata/1.0"})
    ...
    result = {
        "purpose": "Milestone 32 selected-target official metadata completion",
