#!/usr/bin/env python3
"""Fetch the official HD 154345 b orbit and host astrometry only."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results_m21_selected_metadata/hd154345b.json"),
    )
    ...
    request = Request(url, headers={"User-Agent": "setisearch-m21-metadata/1.0"})
    ...
    result = {
        "purpose": "Milestone 21 selected-target official metadata completion",
