#!/usr/bin/env python3
"""Bounded header-only preflight for the two frozen LS8AA WASP43 visits."""
...
OUT=ROOT/'results_ls8aa_l2_metadata'
BASE='https://cheops-webapp-pg.obsuksprd2.unige.ch/'
KEYS=['CH_PR100016_TG007801_V0300','CH_PR100016_TG007802_V0300']
...
def one(key):
 ...
 exp={
  'CH_PR100016_TG007801_V0300':(1,60.,60.),
  'CH_PR100016_TG007802_V0300':(1,60.,60.),
 }[key]
...
def main():
 ...
 cfg=json.loads((ROOT/'config/ls8aa_selected_pair.json').read_text())
 ...
 assert recon['eligible_cohorts'][7]==cfg['cohort']
 assert cfg['cohort']['rank']==8 and cfg['cohort']['normalized_target']=='wasp43'
 ...
 s={'stage':'LS8AA_WASP43_L2_HEADER_PREFLIGHT','status':'PASS_COMPATIBLE' if compatible else 'INCOMPATIBLE',
