#!/usr/bin/env python3
"""Fetch the official HD 19994 b orbit and host astrometry only."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results_m26_selected_metadata/hd19994b.json"),
    )
    ...
    request = Request(url, headers={"User-Agent": "setisearch-m26-metadata/1.0"})
    ...
    result = {
        "purpose": "Milestone 26 selected-target official metadata completion",
