# LS8AF — PG 1207-033 two-visit DEFAULT-L2 screen

Completed 22 September 2026. Result: **COMPLETE_AUDITED**.

The unchanged symmetric screen evaluated **153 table rows** and
...
|---|---:|---:|---:|---:|
| CH_PR100002_TG000901_V0300 | 81 | 117 | 6 / 0 | 1 / 0 |
| CH_PR100002_TG000902_V0300 | 72 | 48 | 0 / 0 | 0 / 0 |
...
`0e006ae040146eb868c3512ab1d13049eef252cb`. Both products have NEXP=1. Their verified
...
Exactly **21,114 science-table bytes** were acquired.
...
|---|---|---:|---:|---:|---:|
| CH_PR100002_TG000901_V0300 | positive | 0 | 60 | 1 | 141.105459184 |
