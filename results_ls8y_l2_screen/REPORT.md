# LS8Y — PG 1245-042 two-visit DEFAULT-L2 screen

Completed 21 September 2026. Result: **COMPLETE_AUDITED**.

The unchanged symmetric screen evaluated **164 table rows** and
**228 eligible, overlapping windows**. It retained
...
|---|---:|---:|---:|---:|
| CH_PR100002_TG008601_V0300 | 85 | 135 | 0 / 4 | 0 / 1 |
| CH_PR100002_TG008602_V0300 | 79 | 93 | 0 / 0 | 0 / 0 |
...
`5918f923186e0006a14a91330eefde33732a6c46`. Both products have NEXP=1. Their verified
...
Exactly **22,632 science-table bytes** were acquired.
...
**2,736 numerical and discrete comparisons**
...
|---|---|---:|---:|---:|---:|
| CH_PR100002_TG008601_V0300 | negative | 0 | 31 | 1 | -18.490171717 |
