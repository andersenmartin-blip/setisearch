# LS8AC — PG1303-114 exact DEFAULT-L2 screen

22 September 2026. **SCIENCE SCOPE FROZEN BEFORE TABLE ACCESS**.

The rank-9 pair passed its public header-only preflight at
`12cd274141861fd6ba7d7ec8add4ae549c93ff41`, following header freeze
`479b7390da988917ebd18f78a8781ae085deb733`. All 28 metadata-manifest entries
...
|---|---:|---:|---:|---:|---:|---:|---:|
| CH_PR100002_TG006401_V0300 | 78 | 138 | 20160 | 30923 | 10764 | 1 | 60 / 60 s |
| CH_PR100002_TG006402_V0300 | 87 | 138 | 20160 | 32165 | 12006 | 1 | 60 / 60 s |

Exactly **22,770 science-table bytes** are authorized.
Source ETags, filenames, total sizes, complete 18-column schema and header
hashes are fixed in config/ls8ac_l2_scope.json. PIPE_VER=14.1.2 in both.
The original/reconciled rank-9 chronology is unchanged. No other aperture,
visit, extension, padding, image or raw imagette is included. The three later
eligible PG1303-114 visits remain outside scope.
...
If neither sign crosses, close this PG1303-114 pair as a descriptive null. The
next predetermined cohort is rank-10 **PG 1207-033**, chronological pair
CH_PR100002_TG000901_V0300 and CH_PR100002_TG000902_V0300, requiring separate
header/table freezes. Do not tune or expand the closed PG1303-114 pair.
