# LS8V — EC 12578-2107 two-visit DEFAULT-L2 screen

Completed 21 September 2026. Result: **COMPLETE_AUDITED**.

The unchanged symmetric screen evaluated **174 table rows** and
**201 eligible, overlapping windows**. It retained
...
|---|---:|---:|---:|---:|
| CH_PR100002_TG008901_V0300 | 87 | 36 | 0 / 0 | 0 / 0 |
| CH_PR100002_TG008902_V0300 | 87 | 165 | 0 / 0 | 0 / 0 |
...
`e3dfd9b6cc82134c770b89469f11e99b1a060f4f`. Both products have NEXP=1. Their verified
...
Exactly **24,012 science-table bytes** were acquired.
...
**2,412 numerical and discrete comparisons**
...
Close this two-visit EC 12578-2107 screen as a descriptive null. The next independent cohort is rank 6 of the unchanged reconciled LS8J ledger, GJ 436. Freeze its exact pair and header preflight before accessing that cohort. Do not widen or retune the closed EC 12578-2107 pair.
