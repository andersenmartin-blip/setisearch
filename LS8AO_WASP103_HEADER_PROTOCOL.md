# LS8AO — WASP-103 DEFAULT-L2 header preflight

22 September 2026. **EXACT PAIR AND HEADER SCOPE FROZEN BEFORE NEW HEADERS OR VALUES**.
Continuation: LS8AN_CONTINUATION.md at
`466032bcb3669e320c73fc74821462670d27117d`.

## Predetermined pair

WASP-103 is rank 14 of the unchanged LS8J metadata-only first-1,000-row
...
|---|---:|---:|---:|
| CH_PR100013_TG000101_V0300 | 58957.9564832128 | 1 | 60 / 60 seconds |
| CH_PR100013_TG000102_V0300 | 58971.8300946827 | 1 | 60 / 60 seconds |

These are the first two of 11 eligible visits in the original WASP-103 cohort.
The remaining nine eligible visits remain outside this transfer.
...
entry 14 to equal config/ls8ao_selected_pair.json. Preserve the original missing
...
Transfer the LS8AL header reader, changing only keys, paths, cohort and the
...
image label becomes a new cut. HD 106315 retains three unresolved labels and
