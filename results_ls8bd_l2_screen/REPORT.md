# LS8BD — GJ 494 two-visit DEFAULT-L2 screen

Completed 24 September 2026. Result: **COMPLETE_AUDITED**.

The unchanged symmetric screen evaluated **148 table rows** and
**165 eligible, overlapping windows**. It retained
**1 positive and 0 negative clusters**.
...
|---|---:|---:|---:|---:|
| CH_PR100018_TG007401_V0300 | 83 | 117 | 2 / 0 | 1 / 0 |
| CH_PR100018_TG007402_V0300 | 65 | 48 | 0 / 0 | 0 / 0 |
...
`905b30a6800a804eef5862e8924636141444306f`. Both products have NEXP=1. Their verified
TEXPTIME values are 42.0 and
42.0 seconds respectively. Durations
are one/two/three rows (CH_PR100018_TG007401_V0300: 42/84/126 seconds; CH_PR100018_TG007402_V0300: 42/84/126 seconds), with 12 sideband rows on each side, two-row guards
...
Exactly **20,424 science-table bytes** were acquired.
...
**1,980 numerical and discrete comparisons**
...
|---|---|---:|---:|---:|---:|
| CH_PR100018_TG007401_V0300 | positive | 0 | 53 | 1 | 17.588818769 |
