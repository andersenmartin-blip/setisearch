# LS8AE — retained PG1303-114 residual and local-noise study
...
LS8AC's 165 rows and 222 eligible overlapping windows have zero positive
crossings and two negative crossings in one cluster. The independent L2
audit passes 2,664 comparisons. Its complete signed representative set has
completed the separately frozen LS8AD image diagnostic and independent audit:
...
TG006402_N0 remains **UNRESOLVED_WITHIN_FIXED_SCOPE**. Both original apertures
are complete and retain the negative L2 sign. DELTA/COR is 0.304773/0.312012;
the column-projected ratios are 0.280911/0.285973, below the fixed 0.5 gate.
COR displacement explained energy is 58.94296%/58.67740%, below 80%, versus
2.97072%/2.83196% for brightness. The smearing regression remains rank deficient.
The specific remaining question is the size and spatial distribution of the
unmodeled residual relative to local variability. Neither a unique cause nor
a calibrated significance follows from the current fits.

This executes the conditional retained-data branch declared in
LS8AD_INPUT_SCOPE.md and LS8AD_PAIRED_IMAGE_PROTOCOL.md. It transfers the
unchanged LS8U duration-aware method, including its independent mathematical
functions, to the one existing 60-second negative context. This is a
retrospective descriptive study, not a new classifier or calibration.

| Item | Fixed value |
|---|---|
| Audited L2 source | `289aae686b9503b555311d41f9306460d02d431a` |
| Audited image source | `37a90e57be86e0e631417a8b0d2acb36bdcd7711` |
| Product key | CH_PR100002_TG006402_V0300 |
| Representative | TG006402_N0, negative, native row 21, local row 14 |
| Duration | One 60-second exposure, NEXP=1 |
| Retained context | Native rows 7:36, 29 rows |
...
All inputs and code dependencies are pinned in config/ls8ae_residuals.json.
Verify the complete LS8AD image manifest and the raw cube digests before use.
...
Original L2 scores, thresholds and the LS8AD label remain unchanged.
...
against LS8AD. Report fixed rings 0–8, 8–16 and 16–25 pixels, four quadrants,
...
negative stays unresolved under LS8AD's fixed gate; no qualified candidate,
detector, sensitivity or observing coverage is added. Do not widen or tune
PG1303-114 further. Its three later eligible visits remain outside scope.
Next is rank-10 **PG 1207-033**, exact chronological pair
CH_PR100002_TG000901_V0300 and CH_PR100002_TG000902_V0300, under a separate
