# LS8AG — exact PG 1207-033 image payload and unchanged diagnostic

22 September 2026. **FROZEN BEFORE IMAGE OR SMEARING VALUES**.
Metadata freeze: `e2fd21766753e713add3aad7e3101b887a24b37c`.
Metadata result: `f1458c934a09c1707cc7f6591a31c84a83debd63`.
...
**TG000901_P0**, positive, L2 row 60, one 60-second exposure,
original score +141.1054591837304. The second selected visit and both
negative cluster sets are empty. The score is not Gaussian sigma.

## Exact source identities and byte intervals

Use only CH_PR100002_TG000901_V0300 CAL/COR products. Exact filenames, ETags,
total sizes and metadata identities are retained in config/ls8ag_images.json.
Both image arrays are unscaled big-endian float64, 200x200 native
ADU, 320,000 bytes per frame. Both products have 81
...
|---|---:|---:|---:|
| SCI_CAL_SubArray | 14737280 | 9280000 | 24017279 |
| SCI_COR_SubArray | 14737280 | 9280000 | 24017279 |
| SMEAR | 26068480 | 46400 | 26114879 |

The original L2 context is 46:75. Native image indices and contiguous
...
in config/ls8ag_payload_scope.json. Verify all pins, freeze HEAD and clean
...
are AST-identical to LS8AD/LS8T. Independently decode retained bytes, check raw
...
close the PG 1207-033 pair and prepare rank-11 EC13080-1508 with separate header/table freezes.
