# LS8AA — WASP-43 two-visit DEFAULT-L2 screen

Completed 21 September 2026. Result: **COMPLETE_AUDITED**.

The unchanged symmetric screen evaluated **271 table rows** and
**294 eligible, overlapping windows**. It retained
...
|---|---:|---:|---:|---:|
| CH_PR100016_TG007801_V0300 | 137 | 174 | 1 / 0 | 1 / 0 |
| CH_PR100016_TG007802_V0300 | 134 | 120 | 0 / 0 | 0 / 0 |
...
`671690401a5ca180ff01af10287171027da8b2b8`. Both products have NEXP=1. Their verified
...
Exactly **37,398 science-table bytes** were acquired.
...
**3,528 numerical and discrete comparisons**
...
|---|---|---:|---:|---:|---:|
| CH_PR100016_TG007801_V0300 | positive | 0 | 62 | 1 | 9.486349814 |
