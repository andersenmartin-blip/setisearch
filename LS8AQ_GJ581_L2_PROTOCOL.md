# LS8AQ — GJ 581 exact DEFAULT-L2 screen

22 September 2026. **SCIENCE SCOPE FROZEN BEFORE TABLE ACCESS**.

The rank-15 pair passed its public header-only preflight at
`ccd12a0597adb66fee10fa36ee52b672f8654be4`, following header freeze
`1e92edfc9fad9025e963a9ed4a9303ab34f4ff52`. All 28 metadata-manifest entries
...
|---|---:|---:|---:|---:|---:|---:|---:|
| CH_PR100011_TG023701_V0300 | 3545 | 138 | 20160 | 509369 | 489210 | 1 | 60 / 60 s |
| CH_PR100018_TG008301_V0300 | 78 | 138 | 20160 | 30923 | 10764 | 1 | 60 / 60 s |

Exactly **499,974 science-table bytes** are authorized.
Source ETags, filenames, total sizes, complete 18-column schema and header
hashes are fixed in config/ls8aq_l2_scope.json. PIPE_VER=14.1.2 in both.
The original/reconciled rank-15 chronology is unchanged. No other aperture,
visit, extension, padding, image or raw imagette is included. These are the first two of seven eligible GJ 581 visits in the original cohort;
the remaining five remain outside this transfer.
...
If neither sign crosses, close this GJ 581 pair as a descriptive null. The
next predetermined cohort is rank-16 **EC 14599-2047**, chronological pair
CH_PR100002_TG010301_V0300 and CH_PR100002_TG010302_V0300, requiring separate
header/table freezes. Do not tune or expand the closed GJ 581 pair.
...
bounded study. WASP-103 remains closed under CORRECTION_LINKED. Other prior
bounded studies remain closed. Reserved TESS/M43
