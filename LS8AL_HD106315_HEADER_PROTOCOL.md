# LS8AL — HD 106315 DEFAULT-L2 header preflight

22 September 2026. **EXACT PAIR AND HEADER SCOPE FROZEN BEFORE NEW HEADERS OR VALUES**.
Continuation: LS8AK_CONTINUATION.md at
`168883e39bd65abd82e9423e9ec81c729e9cc481`.

## Predetermined pair

HD 106315 is rank 13 of the unchanged LS8J metadata-only first-1,000-row
...
|---|---:|---:|---:|
| CH_PR100041_TG000801_V0300 | 58933.4583544308 | 1 | 41 / 41 seconds |
| CH_PR100041_TG001401_V0300 | 58970.6255582254 | 1 | 41 / 41 seconds |

These are the two eligible visits in the original HD 106315 cohort.
...
entry 13 to equal config/ls8al_selected_pair.json. Preserve the original missing
...
Transfer the LS8AK header reader, changing only keys, paths, cohort and the
prospectively required ledger exposure tuple (1, 41, 41). Verify
...
schema. Require PIPE_VER=14.1.2 and NEXP=1, EXPTIME=TEXPTIME=41 seconds
...
41/82/123 seconds), 12 sideband rows and two guards per side, original
...
image label becomes a new cut. PG 1343-102, EC13080-1508, PG 1207-033, PG1303-114, WASP-43, PG 1245-042, GJ 436 and earlier bounded studies remain
