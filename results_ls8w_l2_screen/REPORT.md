# LS8W — GJ 436 two-visit DEFAULT-L2 screen

Completed 21 September 2026. Result: **COMPLETE_AUDITED**.

The unchanged symmetric screen evaluated **640 table rows** and
**936 eligible, overlapping windows**. It retained
...
|---|---:|---:|---:|---:|
| CH_PR100041_TG000302_V0300 | 340 | 558 | 1 / 0 | 1 / 0 |
| CH_PR100041_TG001301_V0300 | 300 | 378 | 0 / 0 | 0 / 0 |
...
`95036f22c891e49e7355dc0893a469879850009d`. Both products have NEXP=1. Their verified
...
Exactly **88,320 science-table bytes** were acquired.
...
**11,232 numerical and discrete comparisons**
...
|---|---|---:|---:|---:|---:|
| CH_PR100041_TG000302_V0300 | positive | 0 | 33 | 1 | 9.634235210 |
