# LS8AQ — GJ 581 DEFAULT-L2 header preflight

22 September 2026. **EXACT PAIR AND HEADER SCOPE FROZEN BEFORE NEW HEADERS OR VALUES**.
Continuation: LS8AP_CONTINUATION.md at
`cc3941c9e9f01b09a31994278e642dc490dc51a0`.

## Predetermined pair

GJ 581 is rank 15 of the unchanged LS8J metadata-only first-1,000-row
...
|---|---:|---:|---:|
| CH_PR100011_TG023701_V0300 | 58963.4726309752 | 1 | 60 / 60 seconds |
| CH_PR100018_TG008301_V0300 | 58973.2698706032 | 1 | 60 / 60 seconds |

These are the first two of seven eligible visits in the original GJ 581 cohort.
The remaining five eligible visits remain outside this transfer.
...
entry 15 to equal config/ls8aq_selected_pair.json. Preserve the original missing
...
Transfer the LS8AO header reader, changing only keys, paths, cohort and the
prospectively required ledger exposure tuple (1, 60, 60). Verify
...
image label becomes a new cut. WASP-103 remains closed under CORRECTION_LINKED.
HD 106315 retains three unresolved labels and
its closed bounded study. PG 1343-102, EC13080-1508, PG 1207-033, PG1303-114, WASP-43, PG 1245-042, GJ 436 and earlier bounded studies remain
