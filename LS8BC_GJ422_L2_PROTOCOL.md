# LS8BC — GJ 422 exact DEFAULT-L2 screen

24 September 2026. **SCIENCE SCOPE FROZEN BEFORE TABLE ACCESS**.

The predetermined rank-22 pair passed its own header preflight. Header freeze:
`e49ae422eaeadef9dada30c1700d25dfcf3f1ba3`; successful header-result commit:
`e02623f5c42c7369b69e39b3eb6c75f267f7317a`.
...
frozen before headers; its PASS result is verification_ls8bc/header_audit.json.
...
|---|---:|---:|---:|---:|---:|---:|---:|
| CH_PR100018_TG012201_V0300 | 48 | 138 | 20160 | 26783 | 6624 | 1 | 60 |
| CH_PR100018_TG012202_V0300 | 49 | 138 | 20160 | 26921 | 6762 | 1 | 60 |

Exactly **13,386 science-table bytes** are authorized. Both products have
PIPE_VER=14.1.2 and independently verified NEXP=1, EXPTIME=TEXPTIME=60 seconds,
...
complete schemas and header hashes are pinned in config/ls8bc_l2_scope.json.
These are both eligible visits for this target in the unchanged ledger.
...
identities, target, rank and next-cohort text differ from LS8BA. The report
...
- Durations: one/two/three rows, independently verified 60/120/180 seconds.
...
windows and prepare **LS8BD, rank-23 GJ 494**, exact chronological first pair
CH_PR100018_TG007401_V0300 / CH_PR100018_TG007402_V0300, under separate header
and table freezes. Its two later visits remain outside that pair and its
science values remain unopened. Do not tune or expand GJ 422 based on its
outcome. A visit with zero eligible windows supplies no tested null.
