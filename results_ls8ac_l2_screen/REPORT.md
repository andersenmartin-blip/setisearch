# LS8AC — PG1303-114 two-visit DEFAULT-L2 screen

Completed 22 September 2026. Result: **COMPLETE_AUDITED**.

The unchanged symmetric screen evaluated **165 table rows** and
**222 eligible, overlapping windows**. It retained
...
|---|---:|---:|---:|---:|
| CH_PR100002_TG006401_V0300 | 78 | 63 | 0 / 0 | 0 / 0 |
| CH_PR100002_TG006402_V0300 | 87 | 159 | 0 / 2 | 0 / 1 |
...
`125088a654731b9bd14c9f5a83841ede1d6165d2`. Both products have NEXP=1. Their verified
...
Exactly **22,770 science-table bytes** were acquired.
...
**2,664 numerical and discrete comparisons**
...
|---|---|---:|---:|---:|---:|
| CH_PR100002_TG006402_V0300 | negative | 0 | 21 | 1 | -10.531570808 |
