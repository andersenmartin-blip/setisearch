"""Known-answer protection for LS8T's one- and three-exposure event sums."""
import unittest
import numpy as np
...
class MixedDurationAnswers(unittest.TestCase):
    def test_one_three_row_sums_and_guards_in_both_signs(self):
        for duration, cadence in ((3, 42.), (1, 49.)):
            n = 28 + duration; time = (np.arange(n, dtype=float) - 14) * cadence
