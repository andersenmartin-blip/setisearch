# LS8AV — GJ 9404 DEFAULT-L2 header preflight

23 September 2026. **EXACT PAIR AND HEADER SCOPE FROZEN BEFORE NEW HEADERS OR VALUES**.
Continuation: LS8AU_CONTINUATION.md at
`bc912811a3be8f3fc7690bc2c5c260cc4f062505`.

## Predetermined pair

GJ 9404 is rank 18 of the unchanged LS8J metadata-only first-1,000-row
...
|---|---:|---:|---:|
| CH_PR100018_TG007301_V0300 | 58973.0244933752 | 1 | 60 / 60 seconds |
| CH_PR100018_TG007302_V0300 | 58975.773334289 | 1 | 60 / 60 seconds |

These are the first two of three eligible visits in the original cohort.
TG007303 stays outside the pair. Exposure values require independent checks
against each product's own FITS headers.
Require the original and reconciled 107-cohort orders to agree completely
and entry 18 to equal config/ls8av_selected_pair.json. Preserve the original
...
Transfer the LS8AU reader, changing only keys, paths, cohort and rank; retain
...
take rank-19 EC14338-1445 under its own header/science freezes. Preserve numerical
...
coverage is established. No prior outcome becomes a new cut. LS IV +09 2
